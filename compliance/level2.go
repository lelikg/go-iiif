...
var level2_spec = `{
    "image": {
    	     "region": {
		       ...
		       "regionByPct":  { "syntax": "pct:x,y,w,h", "required": true, "supported": true, "match": "^pct\\:\\d+(?:\\.\\d+)?\\,\\d+(?:\\.\\d+)?\\,\\d+(?:\\.\\d+)?\\,\\d+(?:\\.\\d+)?$" },
	     ...
	     "quality": {
	     		...
	     		"gray":    { "syntax": "gray",    "required": false, "supported": true, "match": "gr(?:e|a)y$", "default": false },			
